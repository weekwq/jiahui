...
(function(root) {
    ...
    xdr.onload = function() {
      ...
      try {
        response = JSON.parse(xdr.responseText);
            //ajax鑾峰彇ip and port, then set this value
  ...
  /**
   * 鍒濆鍖栨椂闇€瑕佽皟鐢ㄨ繖涓嚱鏁般€傚彲浠ヤ粠BmobSocketIo涓幏鍙栨墍闇€鐨刱ey
   * 
   * @param {String} applicationId 浣犵殑 Application ID.
   * @param {String} applicationKey 浣犵殑 restful api Key.
   * @param {String} masterKey (optional) 浣犵殑 BmobSocketIo Master Key. 
   */
  ...
  BmobSocketIo.serverURL = "http://io.bmob.cn:3010/";
...
//鐩戝惉鏈嶅姟鍣ㄨ繑鍥炵殑鏇存柊鏁版嵁琛ㄧ殑鏁版嵁锛岄渶瑕佺敤鎴烽噸鍐�
...
//鍒濆杩炴帴socket.io鏈嶅姟鍣ㄥ悗锛岄渶瑕佺洃鍚殑浜嬩欢閮藉啓鍦ㄨ繖涓嚱鏁板唴锛�
//娉ㄦ剰锛屽繀椤昏鎶婄洃鍚殑鏁版嵁鍐欏湪杩欎釜鍑芥暟鍐咃紝
//褰撴祻瑙堝櫒鍥犳剰澶栨柇缃戝悗锛屾湇鍔″櫒涓婄殑璁㈤槄浜嬩欢浼氬彇娑堬紝js鑴氭湰浼氶噸鏂拌繛鎺ユ湇鍔″櫒锛屽啓鍦ㄨ繖涓嚱鏁板唴鐨勮闃呬簨浠朵細閲嶆柊鍦ㄦ湇鍔″櫒涓婅闃�
