...
(function(root) {
  ...
  /**
   * 鍒濆鍖栨椂闇€瑕佽皟鐢ㄨ繖涓嚱鏁般€傚彲浠ヤ粠bmob涓幏鍙栨墍闇€鐨刱ey
   * 
   * @param {String} applicationId 浣犵殑 Application ID.
   * @param {String} applicationKey 浣犵殑 restful api Key.
   * @param {String} masterKey (optional) 浣犵殑 bmob Master Key. 
   */
...
(function() {
  ...
  /**
   *
   * <p>Bmob.Events 鏄� fork of Backbone's Events module</p>
   *
...
(function(root) {
  ...
  /**
   * 閫氳繃涓嬮潰鐨勪换鎰忎竴绉嶅舰寮忓彲浠ュ垱寤篏eoPoint<br>
   *   <pre>
   ...
   * @class
   *
   * <p>鍦˙mobObject涓娇鐢ㄥ潗鏍囩偣锛屾垨鑰呭湪geo鏌ヨ涓娇鐢�</p>
   * <p>鍦ㄤ竴涓〃涓彧鏈変竴涓瓧娈佃兘浣跨敤GeoPoint.</p>
   *
   * <p>Example:<pre>
  ...
  /**
   * 浣跨敤鐢ㄦ埛褰撳墠鐨勪綅缃垱寤篏eoPoint瀵硅薄銆�
   * 鎴愬姛鏃惰皟鐢╫ptions.success锛屾垨鑰卭ptions.error銆�
   * @param {Object} options 璋冪敤鎴愬姛鎴栧け璐ョ殑鍥炶皟
   */
  ...
  Bmob.GeoPoint.prototype = {
    ...
    /**
     * 杩斿洖涓や釜geopoint涔嬮棿鐨勫姬搴�
     * @param {Bmob.GeoPoint} point 鍙︿竴涓狟mob.GeoPoint.
     * @return {Number}
     */
...
(function(root) {
  ...
  /**
   * 鍒涘缓ACL
   * 濡傛灉浼犱换浣曞弬鏁帮紝鍒欎换浣曚汉閮芥病鏈夋潈闄�
   * 濡傛灉浼犲叆鐨勫弬鏁版槸Bmob.User锛岄偅涓猽sr浼氭湁璇诲啓鏉冮檺銆�
   * 濡傛灉浼犲叆鐨勫弬鏁版槸json瀵硅薄锛屽垯浼氭湁鐩稿簲鐨刟cl鏉冮檺銆�
   * 
   * @see Bmob.Object#setACL
   * @class
   *
   * <p>鏉冮檺鎺у埗鍙互琚坊鍔犲埌浠讳綍
   * <code>Bmob.Object</code>锛岀敤鏉ユ帶鍒剁敤鎴风殑璁块棶鏉冮檺
   * </p>
   */
  ...
  /**
   * 璁剧疆鏄惁鍏佽鐢ㄦ埛璇诲彇杩欎釜瀵硅薄
   * @param 鐢ㄦ埛id鎴栧璞d锛屾垨Bmob.Role
   * @param {Boolean} 鐢ㄦ埛鏄惁鏈夎鐨勬潈闄�
   */
  ...
  /**
   * 鐢ㄦ埛鏄惁鏈夎鐨勬潈闄愩€�
   * 灏辩畻鏄繑鍥瀎alse锛岀敤鎴锋垨璁稿彲浠ヨ闂璞★紝濡傛灉getPublicReadAccess杩斿洖ture锛屾垨鑰呯敤鎴风殑瑙掕壊鏈夊啓鐨勬潈闄愩€�
   * @param userId 鎴穒d鎴栧璞d, 鎴栬€匓mob.Role.
   * @return {Boolean}
   */
  ...
  /**
   * 璁剧疆鏄惁鍏佽鐢ㄦ埛鏈夊啓鐨勬潈闄�
   * @param userId 鐢ㄦ埛id鎴栧璞d锛屾垨Bmob.Role
   * @param {Boolean} 鐢ㄦ埛鏄惁鏈夊啓鐨勬潈闄�
   */
  ...
  /**
   * 鐢ㄦ埛鎵€灞炵殑瑙掕壊鏄惁鍏佽璇昏繖涓璞°€傚氨绠楄繑鍥瀎alse锛岃繖涓鑹叉垨璁告湁璇荤殑鏉冮檺锛屽鏋滀粬鐨勭埗瑙掕壊鏈夎鐨勬潈闄愩€�
   * @param role 瑙掕壊鍚嶇О锛屾垨鑰� Bmob.Role銆�
   * @return {Boolean} 鏈夎鐨勬潈闄愯繑鍥瀟rue銆�
   * @throws {String} role涓嶆槸Bmob.Role鎴栧瓧绗︿覆銆�
   */
  ...
  /**
   * 鐢ㄦ埛鎵€灞炵殑瑙掕壊鏄惁鍏佽鍐欒繖涓璞°€傚氨绠楄繑鍥瀎alse锛岃繖涓鑹叉垨璁告湁鍐欑殑鏉冮檺锛屽鏋滀粬鐨勭埗瑙掕壊鏈夊啓鐨勬潈闄愩€�
   * @param role 瑙掕壊鍚嶇О锛屾垨鑰� Bmob.Role銆�
   * @return {Boolean} 鏈夊啓鐨勬潈闄愯繑鍥瀟rue銆�
   * @throws {String} role涓嶆槸Bmob.Role鎴栧瓧绗︿覆銆�
   */
  ...
  /**
   * 璁剧疆鐢ㄦ埛鎵€灞炵殑瑙掕壊鏈夎鐨勬潈闄�
   * @param role 瑙掕壊鍚嶇О锛屾垨鑰� Bmob.Role銆�
   * @param {Boolean} 鍏佽瑙掕壊璇昏繖涓璞�
   * @throws {String}  role涓嶆槸Bmob.Role鎴栧瓧绗︿覆銆�
   */
  ...
  /**
   * 璁剧疆鐢ㄦ埛鎵€灞炵殑瑙掕壊鏈夊啓鐨勬潈闄�
   * @param role 瑙掕壊鍚嶇О锛屾垨鑰� Bmob.Role銆�
   * @param {Boolean} 鍏佽瑙掕壊鍐欒繖涓璞�
   * @throws {String}  role涓嶆槸Bmob.Role鎴栧瓧绗︿覆銆�
   */
...
(function(root) {
  ...
  /**
   * @class
   * set鎿嶄綔鏄〃鏄庡瓧娈电殑鍊间細鍦˙mob.Object.set涓敼鍙橈紝鎴栬€呰繖纭畾瑕佷慨鏀瑰€笺€�
   */
  ...
  /**
   * @class
   * 娣诲姞涓€涓厓绱犲埌鏁扮粍涓紝褰撳厓绱犲凡缁忓瓨鍦紝灏嗕笉浼氶噸澶嶆坊鍔犮€�
   */
  ...
  /**
   * @class
   * 鍏崇郴鎿嶄綔鏍囨槑杩欎釜瀛楁鏄疊mob.Relation鐨勫疄浣擄紝鍚屾椂瀵硅薄鍙互浠庡叧绯讳腑娣诲姞鎴栫Щ闄�
   */
  Bmob.Op.Relation = Bmob.Op._extend(
    ...
    /**
     * 杩斿洖娣诲姞鍒板叧绯讳腑鐨凚mob.Object鐨勬暟缁勫璞�
     * @return {Array}
     */
    added: function() {
      var self = this;
...
(function(root) {
  ...
  /**
   *  Bmob.File 淇濆瓨鏂囦欢鍒癰mob
   * cloud.
   * @param name {String} 鏂囦欢鍚嶃€傚湪鏈嶅姟鍣ㄤ腑锛岃繖浼氭敼涓哄敮涓€鐨勬枃浠跺悕
   * @param data {file} 鏂囦欢鐨勬暟鎹�
   *     
   *     鏂囦欢瀵硅薄鏄湪" file upload control"涓閫変腑锛屽彧鑳藉湪涓嬮潰鐨勬祻瑙堝櫒浣跨敤
...
(function(root) {
  ...
  /**
   * Bmob.Role acl鏉冮檺鎺у埗涓殑鐢ㄦ埛瑙掕壊绫�
   *
   * <p>瑙掕壊蹇呴』瑕佹湁鍚嶇О(鍚嶇О鍒涘缓鍚庝笉鑳戒慨鏀�), 鍚屾椂蹇呴』鎸囧畾ACL</p>
   * @class
   * @namespace acl鏉冮檺鎺у埗涓殑鐢ㄦ埛瑙掕壊绫�
   */
  Bmob.Role = Bmob.Object.extend("_Role", /** @lends Bmob.Role.prototype */ {
    // Instance Methods

    /**
     * 閫氳繃鍚嶇О鍜孉CL鏋勯€犱竴涓狟mobRole
     * @param {String} name 鍒涘缓role鐨勫悕绉�
     * @param {Bmob.ACL} acl 杩欎釜瑙掕壊鐨刟cl锛岃鑹插繀椤昏鏈変竴涓狝CL銆�
     */
    ...
    /**
     * 鑾峰彇瑙掕壊鐨刵ame銆傚悓鏃跺彲浠ヤ娇鐢╮ole.get("name")
     * @return {String} 瑙掕壊鐨勫悕绉�
     */
    getName: function() {
    ...
    /**
     * 璁剧疆瑙掕壊鐨勫悕绉般€傝繖涓€煎繀椤昏鍦ㄤ繚瀛樺墠璁剧疆锛岃€屼笖鍙兘璁剧疆涓€娆�
     * <p>
     *   瑙掕壊鐨勫悕绉板彧鑳藉寘鍚暟瀛楋紝瀛楁瘝锛� _, -銆�
     * </p>
     *
     * <p>绛夊悓浜庝娇鐢� role.set("name", name)</p>
     * @param {String} name 瑙掕壊鐨勫悕绉�
     * @param {Object} options 鏍囧噯options瀵硅薄
     */
    ...
    /**
     * 鑾峰彇杩欎釜瑙掕壊瀵瑰簲鐨勭敤鎴稡mob.Users銆傝繖浜涚敤鎴峰凡缁忚鍒嗛厤浜嗘潈闄愶紙渚嬪璇诲啓鐨勬潈闄愶級銆�
     * 浣犺兘閫氳繃relation娣诲姞鍜岀Щ闄よ繖浜涚敤鎴�
     * <p>杩欑瓑鍚屼簬浣跨敤 role.relation("users")</p>
     *
    ...
    /**
     * 鑾峰彇杩欎釜瑙掕壊瀵瑰簲鐨勮鑹睟mob.Roles銆傝繖浜涚敤鎴峰凡缁忚鍒嗛厤浜嗘潈闄愶紙渚嬪璇诲啓鐨勬潈闄愶級銆�
     * 浣犺兘閫氳繃relation娣诲姞鍜岀Щ闄よ繖浜涚敤鎴�
     * <p>杩欑瓑鍚屼簬浣跨敤 role.relation("roles")</p>
     *
...
(function(root) {
  ...
  /**
   *鍒涘缓model鍜宱ptions鐨勫疄浣撱€傜壒鍒湴锛屼綘涓嶄細鐩存帴璋冪敤杩欎釜鏂规硶锛屼綘浼�<code>Bmob.Collection.extend</code>閫氳繃鍒涘缓涓€*涓瓙绫汇€�
   * @param {Array} <code>Bmob.Object</code>鏁扮粍.
   *
   * @param {Object} options  Backbone-style options 鐨勫彲閫塷ptions object.
   * 鏈夋晥鐨� options<ul>
   *   <li>model: Bmob.Object 
   *   <li>query: Bmob.Query
   *   <li>comparator: 灞炴€у悕绉版垨鎺掑簭鍑芥暟
   * </ul>
   *
   * @see Bmob.Collection.extend
   *
   *
   * <p>鎻愪緵鏍囧噯鐨� collection class銆� 鏇磋缁嗙殑淇℃伅璇风湅
  ...
  _.extend(Bmob.Collection.prototype, Bmob.Events,
    ...
    /**
     * Initialize 榛樿鏄┖鍑芥暟. 璇锋牴鎹嚜韬殑閫昏緫閲嶅啓杩欎釜鏂规硶
     */
    initialize: function(){},

    /**
     * 
     * json 鏍煎紡鐨刴odels'灞炴€ф暟缁�
     */
    toJSON: function() {
    ...
    /**
     * 娣诲姞model锛屾垨鑰呬竴绯诲垪鐨勫璞￠泦鍚堛€備紶鍏�**silent**閬垮厤瑙﹀彂`add`浜嬩欢銆�
     */
    ...
    /**
     * 绉婚櫎涓€涓猰odel锛屾垨鑰呬粠闆嗗悎涓Щ闄や竴绯诲垪models銆傚綋绉婚櫎瀵硅薄鏃讹紝浼犲叆silent閬垮厤瑙﹀彂<code>remove</code>浜嬩欢銆�  
     */
    ...
    /**
     * 寮哄埗collection瀵硅嚜韬殑鍏冪礌杩涜閲嶆柊鎺掑簭銆備竴鑸儏鍐典笅浣犱笉闇€瑕佽皟鐢ㄨ繖涓嚱鏁帮紝鍥犱负褰撴坊鍔犲璞℃椂杩欎釜鍑芥暟浼氳嚜鍔ㄨ皟鐢�
     */
...
(function(root) {
   ...
   * @class
   *
   * <p>杩欎釜绫绘槸Bmob.Object鐨勫瓙绫伙紝鍚屾椂鎷ユ湁Bmob.Object鐨勬墍鏈夊嚱鏁帮紝浣嗘槸鎵╁睍浜嗙敤鎴风殑鐗规畩鍑芥暟锛屼緥濡傞獙璇侊紝鐧诲綍绛�</p>   
   */
  Bmob.User = Bmob.Object.extend("_User", /** @lends Bmob.User.prototype */ {
    ...
    /**
     * 娉ㄥ唽涓€涓柊鐢ㄦ埛銆傚綋鍒涘缓涓€涓柊鐢ㄦ埛鏃讹紝搴旇璋冪敤杩欎釜鏂规硶鑰屼笉鏄痵ave鏂规硶銆傝繖涓柟娉曚細鍒涘缓
     * 涓€涓柊鐨凚mob.User鍦ㄦ湇鍔″櫒涓婏紝鍚屾椂淇濆瓨session鍦ㄦ湰鍦扮鐩樺洜姝や綘鍙互閫氳繃<code>current</code>璁块棶user
     * <p>鍦ㄦ敞鍐屽墠蹇呴』璁剧疆username鍜宲assword</p>
     * <p>瀹屾垚鍚庤皟鐢╫ptions.success 鎴栬€� options.error</p>
     *
     * @param {Object} attrs 鐢ㄦ埛鐨勯澶栫殑灞炴€э紝鎴栬€卬ull
     * @param {Object} options Backbone-style options 瀵硅薄銆�
     * @return {Bmob.Promise} 褰撹皟鐢ㄧ粨鏉熷皢浼氳繑鍥瀙romise銆�
    ...
    /**
     * 鐢ㄦ埛鐧诲綍銆傚綋鐧诲綍鎴愬姛锛屽皢浼氫繚瀛榮ession鍦ㄦ湰鍦帮紝鍙互閫氳繃<code>current</code>鑾峰彇鐢ㄦ埛瀵硅薄銆�
     * <p>鍦ㄦ敞鍐屽墠蹇呴』璁剧疆username鍜宲assword</p>
     * <p>瀹屾垚鍚庤皟鐢╫ptions.success 鎴栬€� options.error</p>
     *
     * @param {Object} options  Backbone-style options 瀵硅薄銆�
    ...
    /**
     * 杩斿洖true 濡傛灉<code>current</code>鍙互杩斿洖杩欎釜user銆�
     * @see Bmob.User#cu 浣犱笉鑳芥坊鍔犱竴涓病淇濆瓨鐨凚mob.Object鍒板叧绯讳腑
     */
    isCurrent: function() {
    ...
    /**
     * 璋冪敤 set("username", username, options) 鍚屾椂杩斿洖缁撴灉
    ...
    /**
	 * 璋冪敤 set("password", password, options) 鍚屾椂杩斿洖缁撴灉
    ...
    /**
     * 璋冪敤 set("email", email, options) 鍚屾椂杩斿洖缁撴灉
     * @param {String} email
     * @param {Object} options Backbone-style options 瀵硅薄銆�
     * @return {Boolean}
     * @see Bmob.Object.set
    ...
    /**
     * 妫€鏌ヨ繖涓敤鎴锋槸鍚﹀綋鍓嶇敤鎴峰苟涓斿凡缁忕櫥褰曘€�
     * @return (Boolean) 杩欎釜鐢ㄦ埛鏄惁褰撳墠鐢ㄦ埛骞朵笖宸茬粡鐧诲綍銆�
     */
     ...
     * <p>瀹屾垚鍚庤皟鐢╫ptions.success 鎴栬€� options.error</p>
     *
     * @param {String} username 娉ㄥ唽鐨勭敤鎴峰悕鎴杄mail
     * @param {String} password 娉ㄥ唽鐨勫瘑鐮�
     * @param {Object} attrs 鏂扮敤鎴锋墍闇€瑕佺殑棰濆鏁版嵁
     * @param {Object} options Backbone-style options 瀵硅薄銆�
     * @return {Bmob.Promise} 褰撹皟鐢ㄧ粨鏉熷皢浼氳繑鍥瀙romise銆�
     * @see Bmob.User#signUp
     */
     ...
     * @param {String} username 娉ㄥ唽鐨勭敤鎴峰悕鎴杄mail
     * @param {String} password 娉ㄥ唽鐨勫瘑鐮�
     * @param {Object} options 鏂扮敤鎴锋墍闇€瑕佺殑棰濆鏁版嵁
     * @return {Bmob.Promise} Backbone-style options 瀵硅薄銆�
     * @see Bmob.User#logIn
     */
    ...
    /**
     * 閫€鍑哄綋鍓嶇櫥褰曠殑鐢ㄦ埛銆傜鐩樹腑鐨剆ession灏嗕細琚Щ闄わ紝璋冪敤<code>current</code>灏嗕細
     * 杩斿洖<code>null</code>銆�
     */
    logOut: function() {
     ...
     * 鎶婇噸璁惧瘑鐮佺殑閭欢鍙戦€佸埌鐢ㄦ埛鐨勬敞鍐岄偖绠便€傞偖浠跺厑璁哥敤鎴峰湪bmob缃戠珯涓婇噸璁惧瘑鐮併€�
     * <p>瀹屾垚鍚庤皟鐢╫ptions.success 鎴栬€� options.error</p>
     *
     * @param {String} email 鐢ㄦ埛娉ㄥ唽鐨勯偖绠�
     * @param {Object} options Backbone-style options 瀵硅薄銆�
     */
     ...
     * <p>瀹屾垚鍚庤皟鐢╫ptions.success 鎴栬€� options.error</p>
     *
     * @param {String} email 闇€瑕侀獙璇乪mail鐨別mail鐨勫湴鍧€
     * @param {Object} options Backbone-style options 瀵硅薄銆�
     */
    ...
    /**
     * 杩斿洖褰撳墠宸茬粡鐧婚檰鐨勭敤鎴枫€�
     * @return {Bmob.Object} 宸茬粡鐧诲綍鐨凚mob.User.
     */
    current: function() {
...
(function(root) {
  ...
  /**
   * 涓築mob.Object绫诲垱寤轰竴涓柊鐨刡mob Bmob.Query 銆�
   * @param objectClass -
   *   Bmob.Object鐨勫疄渚嬶紝鎴栬€匓mob绫诲悕
   * 
   *
   * <p>Bmob.Query 涓築mob.Objects瀹氫箟浜唓uery鎿嶄綔銆傛渶甯哥敤鐨勬搷浣滃氨鏄敤query<code>find</code>
   * 鎿嶄綔鍘昏幏鍙栨墍鏈夌殑瀵硅薄銆備緥濡傦紝涓嬮潰绠€鍗曠殑鎿嶄綔鏄幏鍙栨墍鏈夌殑<code>MyClass</code>銆傛牴鎹搷浣滅殑鎴愬姛鎴栧け璐ワ紝
   * 浼氬洖璋冧笉鍚岀殑鍑芥暟銆�      
   * <pre>
   ...
   * });</pre></p>
   *
   * <p>Bmob.Query涔熷彲浠ョ敤鏉ヨ幏鍙栦竴涓猧d宸茬煡鐨勫璞°€備緥濡傦紝涓嬮潰鐨勪緥瀛愯幏鍙栦簡<code>MyClass</code> 鍜� id <code>myId</code>
   * 鏍规嵁鎿嶄綔鐨勬垚鍔熸垨澶辫触锛屼細鍥炶皟涓嶅悓鐨勫嚱鏁般€�  
   * <pre>
   * var query = new Bmob.Query(MyClass);
   * query.get(myId, {
   ...
   * });</pre></p>
   *
   * <p>Bmob.Query 鍚屾椂涔熻兘鑾峰彇鏌ヨ缁撴灉鐨勬暟鐩€備緥濡傦紝涓嬮潰鐨勪緥瀛愯幏鍙栦簡<code>MyClass</code>鐨勬暟鐩�<pre>   
   * var query = new Bmob.Query(MyClass);
   * query.count({
   ...
   * @class Bmob.Query 涓築mob.Objects瀹氫箟浜唓uery鎿嶄綔
   */
  ...
  /**
   * 閫氳繃浼犻€抭uery鏋勯€爋r鐨凚mob.Query瀵硅薄銆�  For
   * example:
   * <pre>var compoundQuery = Bmob.Query.or(query1, query2, query3);</pre>
   * 閫氳繃query1, query2, 鍜� query3鍒涘缓涓€涓猳r鏌ヨ
   * @param {...Bmob.Query} var_args or鐨剄uery鏌ヨ.
   * @return {Bmob.Query} 鏌ヨ缁撴灉.
   */
  ...
  Bmob.Query.prototype = {
    ...
    /**	   
     * 鑾峰彇Bmob.Object锛岄€傜敤浜巌d宸茬粡鐭ラ亾鐨勬儏鍐点€傚綋鏌ヨ瀹屾垚浼氳皟鐢╫ptions.success 鎴� options.error銆�
     * @param {} objectId 瑕佽幏鍙栫殑瀵硅薄id
     * @param {Object} options  Backbone-style options 瀵硅薄.
     */
    ...
    /**
     * 鏌ユ壘婊¤冻鏌ヨ鏉′欢鐨勫璞°€傚畬鎴愬悗锛宱ptions.success 鎴� options.error 浼氳璋冪敤銆�
     * @param {Object} options A Backbone-style options 瀵硅薄.
     * @return {Bmob.Promise} 褰撴煡璇㈠畬鎴愬悗锛岀粨鏋滅殑 promise 浼氳璋冪敤銆�
     */
   ...
   /**
    * 	鎶婃煡璇㈠埌鐨勬墍鏈夊璞″垹闄ゃ€�
    * @param {Object} options 鏍囧噯鐨勫甫 success and error鍥炶皟鐨刼ptions瀵硅薄銆�
    * @return {Bmob.Promise}  褰撳畬鎴愬悗锛岀粨鏋滅殑 promise 浼氳璋冪敤銆�
    */
    ...
    /**
     * 鏌ヨ缁撴灉鐨勬暟鐩€�
     * 瀹屾垚鍚庯紝options.success 鎴� options.error 浼氳璋冪敤銆�
     *
     * @param {Object} options A Backbone-style options 瀵硅薄.
     * @return {Bmob.Promise} 瀹屾垚鍚庯紝缁撴灉鐨� promise 浼氳璋冪敤銆�
     */
    ...
    /**
     * 鍦ㄨ繑鍥炵粨鏋滃墠璁剧疆璺宠繃鐨勭粨鏋滄暟鐩€傛槸鍦ㄥ垎椤垫椂浣跨敤鐨勩€傞粯璁ゆ槸璺宠繃0鏉＄粨鏋溿€�
     * @param {Number} n 璺宠繃鐨勬暟鐩€�
     * @return {Bmob.Query} 杩斿洖鏌ヨ瀵硅薄锛屽洜姝ゅ彲浠ヤ娇鐢ㄩ摼寮忚皟鐢ㄣ€�
     */
    skip: function(n) {
      this._skip = n;
      return this;
    ...
    /**
     * 闄愬埗杩斿洖缁撴灉鐨勬暟鐩€傞粯璁ら檺鍒舵槸100锛屾渶澶ч檺鍒舵暟鏄�1000.
     * @param {Number} n 闄愬埗鐨勬暟鐩€�
     * @return {Bmob.Query} 杩斿洖鏌ヨ瀵硅薄锛屽洜姝ゅ彲浠ヤ娇鐢ㄩ摼寮忚皟鐢ㄣ€�
     */
    limit: function(n) {
      this._limit = n;
    ...
    /**
     * 娣诲姞涓€涓猠qual鏌ヨ锛坘ey value 褰㈠紡锛夈€�
     * @param {String} key key
     * @param value  key瀵瑰簲鐨勫€�
     * @return {Bmob.Query} 杩斿洖鏌ヨ瀵硅薄锛屽洜姝ゅ彲浠ヤ娇鐢ㄩ摼寮忚皟鐢ㄣ€�
     */
    ...
    /**
     * 娣诲姞涓€涓猲ot equal鏌ヨ锛坘ey value 褰㈠紡锛夈€�
     * @param {String} key key
     * @param value  key瀵瑰簲鐨勫€�
     * @return {Bmob.Query} 杩斿洖鏌ヨ瀵硅薄锛屽洜姝ゅ彲浠ヤ娇鐢ㄩ摼寮忚皟鐢ㄣ€�
     */
    ...
    /**
     * 娣诲姞涓€涓皬浜庢煡璇€�
     * @param {String} key 闇€瑕佹鏌ョ殑key.
     * @param value key鎵€瀵瑰簲鐨勫繀椤诲皯浜庣殑鍊�
     * @return {Bmob.Query} 杩斿洖鏌ヨ瀵硅薄锛屽洜姝ゅ彲浠ヤ娇鐢ㄩ摼寮忚皟鐢ㄣ€�
     */
     ...
     * 娣诲姞涓€涓ぇ浜庢煡璇€�
     * @param {String} key 闇€瑕佹鏌ョ殑key.
     * @param value key鎵€瀵瑰簲鐨勫繀椤诲ぇ浜庣殑鍊�
     * @return {Bmob.Query} 杩斿洖鏌ヨ瀵硅薄锛屽洜姝ゅ彲浠ヤ娇鐢ㄩ摼寮忚皟鐢ㄣ€�
     */
     ...
     * 娣诲姞涓€涓皬浜庣瓑浜庢煡璇€�
     * @param {String} key 闇€瑕佹鏌ョ殑key.
     * @param value key鎵€瀵瑰簲鐨勫繀椤诲皯浜庣瓑浜庣殑鍊�
     * @return {Bmob.Query} 杩斿洖鏌ヨ瀵硅薄锛屽洜姝ゅ彲浠ヤ娇鐢ㄩ摼寮忚皟鐢ㄣ€�
     */
     ...
     * 娣诲姞涓€涓ぇ浜庣瓑浜庢煡璇€�
     * @param {String} key 闇€瑕佹鏌ョ殑key.
     * @param value key鎵€瀵瑰簲鐨勫繀椤诲ぇ浜庣瓑浜庣殑鍊�
     * @return {Bmob.Query} 杩斿洖鏌ヨ瀵硅薄锛屽洜姝ゅ彲浠ヤ娇鐢ㄩ摼寮忚皟鐢ㄣ€�
     */
    ...
    /**
     * 娣诲姞key涓寘鍚换鎰忎竴涓€兼煡璇€�
     * @param {String} key 闇€瑕佹鏌ョ殑key.
     * @param {Array} values 闇€瑕佸寘鍚殑鍊肩殑鏁扮粍
     * @return {Bmob.Query} 杩斿洖鏌ヨ瀵硅薄锛屽洜姝ゅ彲浠ヤ娇鐢ㄩ摼寮忚皟鐢ㄣ€�
     */
    ...
    /**
     * 娣诲姞key涓笉鍖呭惈浠绘剰涓€涓€兼煡璇€�
     * @param {String} key 闇€瑕佹鏌ョ殑key.
     * @param {Array} values 涓嶉渶瑕佸寘鍚殑鍊肩殑鏁扮粍
     * @return {Bmob.Query} 杩斿洖鏌ヨ瀵硅薄锛屽洜姝ゅ彲浠ヤ娇鐢ㄩ摼寮忚皟鐢ㄣ€�
     */
     ...
     * 娣诲姞key涓寘鍚叏閮ㄥ€兼煡璇€�
     * @param {String} key 闇€瑕佹鏌ョ殑key
     * @param {Array} values 闇€瑕佸寘鍚殑鍏ㄩ儴鍊肩殑鏁扮粍
     * @return {Bmob.Query} 杩斿洖鏌ヨ瀵硅薄锛屽洜姝ゅ彲浠ヤ娇鐢ㄩ摼寮忚皟鐢ㄣ€�
     */
    ...
    /**
     * 娣诲姞key鏄惁瀛樺湪鐨勬煡璇€�
     * @param {String} key 闇€瑕佹鏌ユ槸鍚﹀瓨鍦ㄧ殑key銆�
     * @return {Bmob.Query} 杩斿洖鏌ヨ瀵硅薄锛屽洜姝ゅ彲浠ヤ娇鐢ㄩ摼寮忚皟鐢ㄣ€�
     */
    exists: function(key) {
    ...
    /**
     * 娣诲姞key鏄惁涓嶅瓨鍦ㄧ殑鏌ヨ銆�
     * @param {String} key 闇€瑕佹鏌ユ槸鍚︿笉瀛樺湪鐨刱ey銆�
     * @return {Bmob.Query}杩斿洖鏌ヨ瀵硅薄锛屽洜姝ゅ彲浠ヤ娇鐢ㄩ摼寮忚皟鐢ㄣ€�
     */
    ...
    /**
     * 娣诲姞姝ｅ垯琛ㄨ揪寮忕殑鏌ヨ銆�
     * 褰撴暟鎹緢澶х殑鏃跺€欒繖涓搷浣滃彲鑳藉緢鎱€�
     * @param {String} key 闇€瑕佹鏌ョ殑key
     * @param {RegExp} regex 闇€瑕佸尮閰嶇殑姝ｅ垯琛ㄨ揪寮�
     * @return {Bmob.Query} 杩斿洖鏌ヨ瀵硅薄锛屽洜姝ゅ彲浠ヤ娇鐢ㄩ摼寮忚皟鐢ㄣ€�
     */
    ...
    /**
     * 娣诲姞涓€涓狟mob.Query鐨勫尮閰嶆煡璇€�
     * @param {String} key 闇€瑕佹鏌ョ殑key銆�
     * @param {Bmob.Query} query 闇€瑕佸尮閰嶇殑query
     * @return {Bmob.Query} 杩斿洖鏌ヨ瀵硅薄锛屽洜姝ゅ彲浠ヤ娇鐢ㄩ摼寮忚皟鐢ㄣ€�
     */
   ...
   /**
     * 娣诲姞涓€涓狟mob.Query鐨勪笉鍖归厤鏌ヨ銆�
     * @param {String} key 闇€瑕佹鏌ョ殑key銆�
     * @param {Bmob.Query} 涓嶉渶瑕佸尮閰嶇殑query
     * @return {Bmob.Query} 杩斿洖鏌ヨ瀵硅薄锛屽洜姝ゅ彲浠ヤ娇鐢ㄩ摼寮忚皟鐢ㄣ€�
     */
    ...
    /**
     * 娣诲姞鏌ヨ锛� key's value 鍖归厤涓€涓璞★紝杩欎釜瀵硅薄閫氳繃涓嶅悓鐨凚mob.Query杩斿洖銆�
     * @param {String} key 闇€瑕佸尮閰嶇殑key鍊�
     * @param {String} queryKey 杩斿洖閫氳繃鍖归厤鐨勬煡璇㈢殑瀵硅薄鐨勯敭 
     * @param {Bmob.Query} query 闇€瑕佽繍琛岀殑鏌ヨ
     * @return {Bmob.Query} 杩斿洖鏌ヨ瀵硅薄锛屽洜姝ゅ彲浠ヤ娇鐢ㄩ摼寮忚皟鐢ㄣ€�
     */
    ...
    /**
     * 娣诲姞鏌ヨ锛� key's value 涓嶅尮閰嶄竴涓璞★紝杩欎釜瀵硅薄閫氳繃涓嶅悓鐨凚mob.Query杩斿洖銆�
     * @param {String} key 闇€瑕佸尮閰嶇殑key鍊�
     *                     excluded.
     * @param {String} queryKey 杩斿洖閫氳繃涓嶅尮閰嶇殑鏌ヨ鐨勫璞＄殑閿� 
     * @param {Bmob.Query} query 闇€瑕佽繍琛岀殑鏌ヨ
     * @return {Bmob.Query} 杩斿洖鏌ヨ瀵硅薄锛屽洜姝ゅ彲浠ヤ娇鐢ㄩ摼寮忚皟鐢ㄣ€�
     */
    ...
    /**
     * 鏌ユ壘涓€涓€间腑鏄惁鍖呭惈鏌愪釜瀛愪覆銆傚湪澶ч噺鐨勬暟鎹腑锛岃繖涓搷浣滃彲鑳藉緢鎱€�
     * @param {String} key 闇€瑕佹煡鎵剧殑鍊�
     * @param {String} substring 闇€瑕佸尮閰嶅瓙涓�
     * @return {Bmob.Query} 杩斿洖鏌ヨ瀵硅薄锛屽洜姝ゅ彲浠ヤ娇鐢ㄩ摼寮忚皟鐢ㄣ€�
     */
    ...
    /**
     * 妫€鏌ユ煇涓€兼槸鍚︿互鐗规畩鐨勫瓧绗︿覆寮€澶淬€� 杩欐煡璇娇鐢ㄤ簡backend index锛屽洜姝ゅ湪澶ф暟鎹腑涔熷緢蹇€�
     * @param {String} key 闇€瑕佹煡鎵剧殑鍊�
     * @param {String} prefix 闇€瑕佸尮閰嶅瓙涓�
     * @return {Bmob.Query} 杩斿洖鏌ヨ瀵硅薄锛屽洜姝ゅ彲浠ヤ娇鐢ㄩ摼寮忚皟鐢ㄣ€�
     */
    ...
    /**
     * 妫€鏌ユ煇涓€兼槸鍚︿互鐗规畩鐨勫瓧绗︿覆缁撳熬銆傚湪澶ч噺鐨勬暟鎹腑锛岃繖涓搷浣滃彲鑳藉緢鎱€�
     * @param {String} key 闇€瑕佹煡鎵剧殑鍊�
     * @param {String} suffix 闇€瑕佸尮閰嶅瓙涓�
     * @return {Bmob.Query} 杩斿洖鏌ヨ瀵硅薄锛屽洜姝ゅ彲浠ヤ娇鐢ㄩ摼寮忚皟鐢ㄣ€�
     */
    ...
    /**
     * 鏌ユ壘涓€涓猤eo point 闄勮繎鐨勫潗鏍囥€�
     * @param {String} key Bmob.GeoPoint鐨刱ey
     * @param {Bmob.GeoPoint} point 鎸囧悜涓€涓� Bmob.GeoPoint 
     * @return {Bmob.Query} 杩斿洖鏌ヨ瀵硅薄锛屽洜姝ゅ彲浠ヤ娇鐢ㄩ摼寮忚皟鐢ㄣ€�
     */
    ...
    /**
     * 娣诲姞鐢ㄤ簬鏌ユ壘闄勮繎鐨勫璞★紝骞跺熀浜庡姬搴︾粰鍑烘渶澶ц窛绂诲唴鐨勭偣銆�
     * @param {String} key Bmob.GeoPoint鐨刱ey
     * @param {Bmob.GeoPoint} point 鎸囧悜涓€涓� Bmob.GeoPoint 
     * @param maxDistance 杩斿洖鐨勬渶澶ц窛绂伙紝鍩轰簬寮у害.
     * @return {Bmob.Query} 杩斿洖鏌ヨ瀵硅薄锛屽洜姝ゅ彲浠ヤ娇鐢ㄩ摼寮忚皟鐢ㄣ€�
     */
    ...
    /**
     * 娣诲姞鐢ㄤ簬鏌ユ壘闄勮繎鐨勫璞★紝骞跺熀浜庣背缁欏嚭鏈€澶ц窛绂诲唴鐨勭偣銆�
     * @param {String} key Bmob.GeoPoint鐨刱ey
     * @param {Bmob.GeoPoint} point 鎸囧悜涓€涓� Bmob.GeoPoint 
     * @param maxDistance 杩斿洖鐨勬渶澶ц窛绂伙紝鍩轰簬寮у害.
     * @return {Bmob.Query} 杩斿洖鏌ヨ瀵硅薄锛屽洜姝ゅ彲浠ヤ娇鐢ㄩ摼寮忚皟鐢ㄣ€�
    ...
    /**
     * 娣诲姞鐢ㄤ簬鏌ユ壘闄勮繎鐨勫璞★紝骞跺熀浜庡崈绫崇粰鍑烘渶澶ц窛绂诲唴鐨勭偣銆�
     * @param {String} key Bmob.GeoPoint鐨刱ey
     * @param {Bmob.GeoPoint} point 鎸囧悜涓€涓� Bmob.GeoPoint 
     * @param maxDistance 杩斿洖鐨勬渶澶ц窛绂伙紝鍩轰簬寮у害.
     * @return {Bmob.Query} 杩斿洖鏌ヨ瀵硅薄锛屽洜姝ゅ彲浠ヤ娇鐢ㄩ摼寮忚皟鐢ㄣ€�
    ...
    /**
     * 鍦ㄤ竴涓洓杈瑰舰鑼冨洿鍐咃紝鏌ユ壘鏌愪釜鐐归檮杩戠殑瀵硅薄
     * @param {String} key The key to be constrained.
     * @param {Bmob.GeoPoint} southwest 杩欎釜鍥涜竟褰㈢殑鍗楄タ鏂瑰悜
     * @param {Bmob.GeoPoint} northeast 杩欎釜鍥涜竟褰㈢殑涓滃寳鏂瑰悜 
     * @return {Bmob.Query} 杩斿洖鏌ヨ瀵硅薄锛屽洜姝ゅ彲浠ヤ娇鐢ㄩ摼寮忚皟鐢ㄣ€�
     */
    ...
    /**
     * 褰撹幏鍙栫殑Bmob.Objects鏈夋寚鍚戝叾瀛愬璞＄殑Pointer绫诲瀷鎸囬拡Key鏃讹紝浣犲彲浠ュ姞鍏nclue閫夐」鏉ヨ幏鍙栨寚閽堟寚鍚戠殑瀛愬璞�
     * @param {String} key 闇€瑕佸寘鍚殑key鐨勫€�
     * @return {Bmob.Query} 杩斿洖鏌ヨ瀵硅薄锛屽洜姝ゅ彲浠ヤ娇鐢ㄩ摼寮忚皟鐢ㄣ€�
     */
    include: function() {
      var self = this;
    ...
    /**
     * 鍖归厤鍙︿竴涓煡璇㈢殑杩斿洖鍊硷紝濡傛灉杩欎釜鍑芥暟琚皟鐢ㄥ娆★紝姣忔璋冪敤鏃舵墍鏈夌殑keys灏嗕細琚寘鍚€�
     * @param {Array} keys 闇€瑕佸寘鍚殑key鐨勫€�
     * @return {Bmob.Query} 杩斿洖鏌ヨ瀵硅薄锛屽洜姝ゅ彲浠ヤ娇鐢ㄩ摼寮忚皟鐢ㄣ€�
     */
    select: function() {
      var self = this;
    ...
    /**
     * 瀵规煡璇㈢殑姣忎釜缁撴灉璋冪敤鍥炶皟鍑芥暟銆�
     * 濡傛灉callback杩斿洖promise锛岃繖涓凯浠ｅ櫒涓嶄細缁х画鐩村埌鎵€鏈夌殑promise璋冪敤瀹屾瘯銆�
     * 濡傛灉鍥炶皟杩斿洖鎷掔粷promise锛岃凯浠ｄ細鍋滄銆�
     * 鎵€鏈夊璞″皢浠ヤ笉鎺掑簭鐨勫舰寮忓鐞嗐€�
     * 鏌ヨ灏嗕笉浼氭湁浠讳綍鐨勬帓搴忥紝鍚屾椂limit 鎴杝kip 灏嗘棤鏁堛€�
     * @param callback {Function} 姣忎釜缁撴灉璋冪敤鐨勫洖璋冨嚱鏁�
     * @param options {Object} 鍙€夌殑 Backbone-like 甯︽垚鍔熸垨澶辫触鐨勫洖璋冿紝鍥炶皟灏嗕細鎵ц褰撹凯浠ｇ粨鏉熺殑鏃跺€欍€�
     * @return {Bmob.Promise} 褰撹凯浠ｇ粨鏉熺殑鏃跺€橝 promise 灏嗕細鎵ц涓€娆°€�
     */
...
(function(root) {
   ...
   * 鈥� you should use the reference to <code>Bmob.history</code>
...
(function(root) {
  ...
  _.extend(Bmob.Image, /** @lends Bmob.Image */  {
    /**
     * 璋冪敤鐢熸垚缂╃暐鍥剧殑鍑芥暟銆�
     * @param {Object} 鐩稿簲鐨勫弬鏁�
     * @param {Object} Backbone-style options 瀵硅薄銆� options.success, 濡傛灉璁剧疆浜嗭紝灏嗕細澶勭悊浜戠浠ｇ爜璋冪敤鎴愬姛鐨勬儏鍐点€� options.error 濡傛灉璁剧疆浜嗭紝灏嗕細澶勭悊浜戠浠ｇ爜璋冪敤澶辫触鐨勬儏鍐点€� 涓や釜鍑芥暟閮芥槸鍙€夌殑銆備袱涓嚱鏁伴兘鍙湁涓€涓弬鏁般€�
     * @return {Bmob.Promise} A promise 灏嗕細澶勭悊浜戠浠ｇ爜璋冪敤鐨勬儏鍐点€�
     */
...
(function(root) {
  ...
  _.extend(Bmob.Cloud, /** @lends Bmob.Cloud */ {
    /**
     * 杩愯浜戠浠ｇ爜
     * @param {String} 浜戠浠ｇ爜鐨勫嚱鏁板悕
     * @param {Object} 浼犱汉浜戠浠ｇ爜鐨勫弬鏁�
     * @param {Object} options  Backbone-style options 瀵硅薄銆�
     * options.success, 濡傛灉璁剧疆浜嗭紝灏嗕細澶勭悊浜戠浠ｇ爜璋冪敤鎴愬姛鐨勬儏鍐点€�  options.error 濡傛灉璁剧疆浜嗭紝灏嗕細澶勭悊浜戠浠ｇ爜璋冪敤澶辫触鐨勬儏鍐点€�  涓や釜鍑芥暟閮芥槸鍙€夌殑銆備袱涓嚱鏁伴兘鍙湁涓€涓弬鏁般€�
     * @return {Bmob.Promise} A promise 灏嗕細澶勭悊浜戠浠ｇ爜璋冪敤鐨勬儏鍐点€�
     */
...
(function(root) {
  ...
  /**
   * 鎺ㄩ€佹秷鎭�
   * @param {Object} data -  鍏蜂綋鐨勫弬鏁拌鏌ョ湅<a href="http://docs.bmob.cn/restful/developdoc/index.html?menukey=develop_doc&key=develop_restful">鎺ㄩ€佹枃妗�</a>.
   * @param {Object} options options 瀵硅薄銆� options.success, 濡傛灉璁剧疆浜嗭紝灏嗕細澶勭悊浜戠浠ｇ爜璋冪敤鎴愬姛鐨勬儏鍐点€� options.error 濡傛灉璁剧疆浜嗭紝灏嗕細澶勭悊浜戠浠ｇ爜璋冪敤澶辫触鐨勬儏鍐点€� 涓や釜鍑芥暟閮芥槸鍙€夌殑銆備袱涓嚱鏁伴兘鍙湁涓€涓弬鏁般€�
   */
